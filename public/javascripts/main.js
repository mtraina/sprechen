...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), (function() { return this; }()), __webpack_require__(169)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RecordUploader = __webpack_require__(240);

	var _RecordUploader2 = _interopRequireDefault(_RecordUploader);

	var _VoiceRecorder = __webpack_require__(245);
	...
	var CommentBox = function (_React$Component) {
	  ...
	  function CommentBox(props) {
	    ...
	    _this.state = { guesses: [] };
	    _this.sendSpeech = _this.sendSpeech.bind(_this);
	    return _this;
	  }

	  _createClass(CommentBox, [{
	    key: "sendSpeech",
	    value: function sendSpeech(blob) {
	      var _this2 = this;
	      ...
	      fetch("/recognize", {
	        ...
	        _this2.setState({ guesses: json.guesses });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(_RecordUploader2.default, { handleSpeech: this.sendSpeech }),
	        _react2.default.createElement(_VoiceRecorder2.default, { handleSpeech: this.sendSpeech }),
	        _react2.default.createElement(_List2.default, { id: "list", data: this.state.guesses })
	      );
	    }
	  }]);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.data.map(function (d, i) {
	            return _react2.default.createElement(ListItem, { key: i, data: d });
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recorderjs = __webpack_require__(241);
	...
	var RecordUploader = function (_React$Component) {
	  _inherits(RecordUploader, _React$Component);

	  function RecordUploader(props) {
	    _classCallCheck(this, RecordUploader);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RecordUploader).call(this, props));

	    _this.previewFile = _this.previewFile.bind(_this);
	    return _this;
	  }

	  _createClass(RecordUploader, [{
	    key: "previewFile",
	    value: function previewFile(event) {
	      var _this2 = this;

	      console.log("previewFile...in");

	      var file = document.querySelector("#audio").files[0];
	      var reader = new FileReader();

	      reader.onloadend = function (upload) {
	        return _this2.props.handleSpeech(file);
	      };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("input", { id: "audio", type: "file", onChange: this.previewFile })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(242).Recorder;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inlineWorker = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VoiceRecorder = function (_React$Component) {
	  _inherits(VoiceRecorder, _React$Component);
	  ...
	  _createClass(VoiceRecorder, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "button",
	          { id: "start", onClick: this.startRecording },
	          "record"
	        ),
	        _react2.default.createElement(
	          "button",
	          { id: "stop", onClick: this.stopRecording },
	          "stop"
	        )
	      );
	    }
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        _Layout2.default,
	        null,
	        _react2.default.createElement(_Article2.default, { data: this.props.route.data })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Article = function (_React$Component) {
	  ...
	  _createClass(Article, [{
	    key: "render",
	    value: function render() {
	      var body = this.props.data.body.map(function (p, i) {
	        return _react2.default.createElement(
	          "p",
	          { key: i },
	          p
